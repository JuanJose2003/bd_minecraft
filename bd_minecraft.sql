...
id_jugador int not null,
primary key (ip_servidor, id_jugador)
);
create table mundo (
...
primary key (id_bioma)
 ...
 primary key (id_recurso,id_mundo)
 );
 ...
 id_mundo int not null,
 primary key (id_elemento, id_mundo)
 );
...
insert into servidores value (105.10,'Hypixel','estable',2013,98985);
insert into servidores value (110.3,'Supercraft','estable',2020,45879);
insert into servidores value (99.10,'Complex Gaming','inestable',2019,77584);
insert into servidores value (140.5,'ZoneCraft ','estable',2019,42236);
insert into servidores value (187.1,'2b2t','inestable',2010,45678); 
...
insert into recursos value (1,'oro','mineria',20);
insert into recursos value (2,'hierro','mineria',21);
insert into recursos value (3,'diamante','mineria',22);
insert into recursos value (4,'madera','arboles',23);
insert into recursos value (5,'piedra','tierra',24);
...
insert into elementos value (11,'armadura','hierro', 20);
insert into elementos value (12,'carne','animales', 21);
insert into elementos value (13,'tnt','polvora', 22);
insert into elementos value (14,'tinte','flores', 23);
insert into elementos value (15,'libros','papel', 24);
